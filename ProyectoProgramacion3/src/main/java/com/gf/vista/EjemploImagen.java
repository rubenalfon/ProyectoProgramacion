 ...
 * @author Ruben
 */
public class EjemploImagen extends javax.swing.JFrame {

    /**
     * Creates new form EjemploImagen
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjemploImagen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjemploImagen().setVisible(true);
            }
        });
    }
